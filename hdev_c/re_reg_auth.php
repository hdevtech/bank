<div class="box">
  ...
  <form id="login_form" class="form-signin" method="POST">
    ...
    <div class="inputBox">
      ...
      <button type="button" class="btn btn-primary btn-block ftb" data-toggle="modal" data-target=".modal-reg"><i class="fas fa-plus-circle"></i> Register as new Landlord</button>&nbsp;
      <?php endif ?>
    </div>
