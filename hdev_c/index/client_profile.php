              ...
              <div class="card-body table-responsive p-0">
                <div class="row">
                  ...
                  <tbody>
                    <tr>
                      <td>Names :</td> 
                      <td><?php echo hdev_data::client(hdev_log::uid(),['data'])["c_name"]; ?></td>
                    </tr>
                    <tr>
                    <td>National Id :</td>
                      <td><?php echo hdev_data::client(hdev_log::uid(),['data'])["c_nid"]; ?></td>
                    </tr>
                    <tr>
                      <td>Email :</td>
                      <td><?php echo hdev_data::client(hdev_log::uid(),['data'])["c_email"]; ?></td>
                    </tr>
                    <tr>
                      <td>Telephone :</td>
                      <td><?php echo hdev_data::client(hdev_log::uid(),['data'])["c_tell"]; ?></td>
                    </tr>
                    <tr>
                      <td>Reg_no :</td>
                      <td><span class='text-success'><?php echo hdev_data::client(hdev_log::uid(),['data'])["c_id"]; ?></span></td>
                    </tr>
                  </tbody>
                </table>
                  </div>
          ...
          <div class="card-body register-card-body table-responsive p-3">
            ...
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" name="name" id="name" class="form-control" placeholder="Names" required="true" value="<?php echo hdev_data::client(hdev_log::uid(),['data'])["c_name"]; ?>">
              </div>
            </div>
            <div class="form-group">
              <label for="email">
              ...
              <div class="input-group mb-3">
                ...
                <input type="email" name="email" id="email" class="form-control" placeholder="Email" required="required" value="<?php echo hdev_data::client(hdev_log::uid(),['data'])["c_email"]; ?>">
            ...
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" id="tel" name="tel" class="form-control" placeholder="Telephone" required="true" maxlength="10" value="<?php echo hdev_data::client(hdev_log::uid(),['data'])["c_tell"]; ?>">
              </div>
            </div>
            <div class="wait" align="center"></div>
