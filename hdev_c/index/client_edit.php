<?php 
  ...
  $data = hdev_data::client($c_id,['data']);
      ...
      <div class="row">
          <div class="col-sm-12">
            <div class="card card-primary card-outline" style="height: 100%;">
              <div class="card-header">Edit Client Info</h5>
              </div>
          ...
          <div class="card-body register-card-body table-responsive p-3">
            ...
            <form method="post" id="client_reg">
              ...
              <input type="hidden" name="ref" value="client_edit">
            ...
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" id="c_acc" name="c_acc" class="form-control" placeholder="Client Account Number" required="true" value="<?php echo $data['c_acc'] ?>">
              </div>
            </div>            
            <div class="form-group">
              <label for="c_dob">
          ...
          <div class="card-footer">
            <button type="button" class="btn btn-primary btn-block" id="reg_client"><i class="fas fa-save"></i> Save Client Info</button>
          </div>
          <!-- /.form-box -->
        </div><!-- /.card -->
              </div>
