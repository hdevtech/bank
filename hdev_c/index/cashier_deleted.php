      ...
      <div class="row">
          <div class="col-sm-12">
            <div class="card card-primary card-outline" style="height: 100%;">
              <div class="card-header">Deleted Cashiers</h5>
              </div>
              <div class="card-body table-responsive p-2">
                <?php //var_dump(hdev_data::get_student('',['year'])); ?>
                  ...
                  <tbody>
                    ...
                    <?php foreach (hdev_data::cashier('',['delete']) AS $cashier) { 
                      $csrf = new CSRF_Protect();
                      $tkn = $csrf->getToken();
                      $build2 = "ref:cashier_recover;id:".$cashier['c_id'].";src:1;from:".urlencode(hdev_url::get_url_host().$_SESSION['act_url'][2]);
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="btn-group btn-group-sm">
                          <?php if (hdev_data::service('cashier_recover')): ?>
                          <button type="button" hash="<?php echo $tkn; ?>" data="<?php echo $reject; ?>" rel="external" class="btn btn-secondary ld_delete" dob="<?php echo $cashier["c_dob"]; ?>" name="<?php echo $cashier["c_name"]; ?>" nid="<?php echo $cashier["c_nid"]; ?>" data-toggle="modal" data-target=".modal-delete"><i class="fas fa-recycle"></i> Recover </button>
                           <?php endif ?>
                        </div>
                      </td>
                      <?php endif ?> 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
         ...
         <div class="card">
          <div class="card-body register-card-body table-responsive p-3">
              ...
              <table class="table border-bottom">
                <tr>
                  <th colspan="2">Are you susre you want to recover this Cashier?</th>
                </tr>
                <tr>
                  <td>Names : </td>
      ...
      <div class="modal-footer justify-content-between">
        ...
        <button type="button" class="btn btn-success" id="cashier_delete" data="" hash=""><i class="fas fa-check-circle"></i> Recover This Cashier</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
