      ...
      <div class="row">
          <div class="col-sm-12">
            <div class="card card-primary card-outline" style="height: 100%;">
              <div class="card-header">Approved Certificates</h5>
              </div>
              <div class="card-body table-responsive p-2">
                <?php //var_dump(hdev_data::get_student('',['year'])); ?>
                  ...
                  <tbody>
                    ...
                    <?php foreach (hdev_data::application() AS $transaction) { 
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="btn-group btn-group-sm">
                          <a ext_link="ok" target="_blank" href="<?php echo hdev_url::menu('cert/gen/view/'.$transaction['t_id']); ?>" class="btn btn-success"><i class="fa fa-print"></i> Print</a>
                        </div>
                      </td>
                    </tr>
                  <?php } ?>
